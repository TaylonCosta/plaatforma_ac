...
class MenuObject:
    def __init__(
            self, order, slug, title, url='None', icon='fa-circle-o', visible=True, iframe=False, has_help=False,
            extra_info=None):
        self.order = order
        self.slug = slug
        self.title = title
...
MENUS = [
    ...
    MenuObject(order=5502, slug='registros.categoria.*', title="Categoria", icon='fa-user-secret'),
    ...
    MenuObject(order=5502, slug='registros.submicao-aluno.*', title="Submição", icon='fa-user-secret'),
    MenuObject(order=550201, slug='registros.submicao-aluno.submicoes', title="Submições", url=reverse("submicao-aluno-list"),
               icon='fa-database', has_help=False),

    MenuObject(order=5503, slug='registros.submicao.*', title="Submiçôes Abertas", icon='fa-user-secret'),
    MenuObject(order=550301, slug='registros.submicao.submicoes', title="Submições Abertas", url=reverse("submicao-list"),
               icon='fa-database', has_help=False),


    MenuObject(order=66, slug='certificados.*', title="Gestão Certificado", url=reverse("certificados-dashboard")),
    MenuObject(order=6602, slug='certificados.certificados.*', title="Categoria", icon='fa-user-secret'),
